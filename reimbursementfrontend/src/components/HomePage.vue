<template>
  <nav class="flex justify-between px-20 py-10 items-center bg-white">
    <h1 class="text-xl text-gray-800 font-bold">Reimbursement Tracking</h1>
    <div class="flex items-center">
      ...
      <ul class="flex items-center space-x-6 cursor-default">
        <li class="font-semibold text-gray-700">Dashboard</li>
        <li class="font-semibold text-gray-700">My Request</li>
        <li class="font-semibold text-gray-700">Policies</li>
        <li class="font-semibold text-gray-700">Bank Details</li>
